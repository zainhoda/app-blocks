							...
							_1: _elm_lang$core$Json_Encode$object(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'title',
										_1: _elm_lang$core$Json_Encode$string(model.head.title)
									},
									_1: {ctor: '[]'}
								})
						},
...
var _zainhoda$app_blocks$Main$stringInput = F3(
	function (inputName, str, updateFn) {
		return A2(
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'font-family', _1: '\'Roboto\', sans-serif'},
												_1: {
													ctor: '::',
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'border-style', _1: 'groove'},
															_1: {
																ctor: '::',
...
var _zainhoda$app_blocks$Main$dropdownInput = F4(
	function (inputName, selectedValue, options, optionFn) {
		return A2(
			...
			_elm_lang$html$Html$button,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'font-family', _1: '\'Roboto Mono\', monospace'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'background-color', _1: 'lightgreen'},
								_1: {
									ctor: '::',
...
var _zainhoda$app_blocks$Main$stylesheet = function () {
	var children = {ctor: '[]'};
	var attrs = {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'href', 'https://fonts.googleapis.com/css?family=Roboto|Roboto+Mono'),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _zainhoda$app_blocks$Main$newJason = _elm_lang$core$Native_Platform.outgoingPort(
	'newJason',
	function (v) {
		return v;
	});
var _zainhoda$app_blocks$Main$renderHtml = function (model) {
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _zainhoda$app_blocks$Main$newJason(
			A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_zainhoda$app_blocks$Main$encodeJson(model)))
	};
};
var _zainhoda$app_blocks$Main$Model = F2(
	function (a, b) {
		return {head: a, body: b};
	});
var _zainhoda$app_blocks$Main$HeadOptions = function (a) {
	return {title: a};
};
var _zainhoda$app_blocks$Main$Body = F2(
	function (a, b) {
		return {header: a, sections: b};
	});
var _zainhoda$app_blocks$Main$Section = F2(
	function (a, b) {
...
var _zainhoda$app_blocks$Main$LabelType = function (a) {
	return {ctor: 'LabelType', _0: a};
};
var _zainhoda$app_blocks$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'UpdateBodyHeader':
				var header = model.body.header;
				var body = model.body;
				return _zainhoda$app_blocks$Main$renderHtml(
			...
			case 'AddBodySection':
				var sections = model.body.sections;
				var body = model.body;
				return _zainhoda$app_blocks$Main$renderHtml(
					_elm_lang$core$Native_Utils.update(
						model,
									...
									sections: A2(
										...
										sections,
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _zainhoda$app_blocks$Main$Component(
														_zainhoda$app_blocks$Main$LabelType(
															{text: 'New Label'})),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
...
var _zainhoda$app_blocks$Main$UpdateComponent = F3(
	function (a, b, c) {
		return {ctor: 'UpdateComponent', _0: a, _1: b, _2: c};
	});
var _zainhoda$app_blocks$Main$SetSectionType = F2(
	function (a, b) {
		return {ctor: 'SetSectionType', _0: a, _1: b};
	});
...
var _zainhoda$app_blocks$Main$editor = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_1: {
					...
					_0: A3(
						...
						model.head.title,
						function (str) {
							return _zainhoda$app_blocks$Main$UpdateHead(
								function (head) {
									return _elm_lang$core$Native_Utils.update(
										head,
										{title: str});
			...
			A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A4(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											'section-type-',
											_elm_lang$core$Basics$toString(sectionNum)),
										section.type_,
										{
											ctor: '::',
											_0: _zainhoda$app_blocks$Main$Vertical,
											_1: {
												ctor: '::',
												_0: _zainhoda$app_blocks$Main$Horizontal,
												_1: {ctor: '[]'}
											}
										},
										_zainhoda$app_blocks$Main$SetSectionType(sectionNum)),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
										...
										_1: {
											ctor: '::',
											_0: A2(
												_zainhoda$app_blocks$Main$btn,
												'Add Component',
												_zainhoda$app_blocks$Main$AddComponent(sectionNum)),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$hr,
				...
				{
					ctor: '::',
					_0: A2(_zainhoda$app_blocks$Main$btn, 'Add Section', _zainhoda$app_blocks$Main$AddBodySection),
					_1: {ctor: '[]'}
				})));
};
var _zainhoda$app_blocks$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _zainhoda$app_blocks$Main$stylesheet,
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'border-right', _1: '1px dotted'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'height', _1: 'calc(100vh - 20px)'},
												_1: {ctor: '[]'}
											}
										}
									}
					...
					},
					{
						...
						_1: {
							ctor: '::',
							_0: _zainhoda$app_blocks$Main$editor(model),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
...
var _zainhoda$app_blocks$Main$main = _elm_lang$html$Html$program(
	{
...
var _zainhoda$app_blocks$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _zainhoda$app_blocks$Main$main !== 'undefined') {
    _zainhoda$app_blocks$Main$main(Elm['Main'], 'Main', undefined);
}
